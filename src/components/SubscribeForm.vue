    ...
    <ValidationObserver ref="observer">
      <b-form id="user-form" v-if="showForm" @submit.prevent="onSubmit" novalidate>
        ...
        <b-form-group
            ...
            description="We'll send the newsletter to this address." label-for="user-address"
        >
        ...
        <b-form-group
            ...
            description="Please Select Birth Date."
        >
          <b-calendar
              id="user-birth-date"
        ...
        <b-form-group
            id="input-user-income"
            label="Income Level: "
            label-for="user-income"
            description="Please Select Your Yearly Income"
        >
          <b-form-select
              id="user-income"
              v-model="form.userIncome"
        ...
        >
          <ValidationProvider name="donationPeriod" rules="required" v-slot="{ errors }">
            <b-form-checkbox-group
                ...
                required
            >
              <b-form-checkbox value="monthly">I Want to Save Polar Bears Every Month!(Montly Recurring Donation)
              </b-form-checkbox>
              <b-form-checkbox value="one-time">I Really Don't Like Polar Bears That Much. (One-time Donation)
              </b-form-checkbox>
            </b-form-checkbox-group>
        ...
        <b-modal id="sub-modal" ref="my-modal" hide-footer title="Subscription Confirmation">
          ...
          <b-button size="sm" variant="outline-danger" block @click="hideSubModal">Watch Polar Bears
            Dying.(Cancel Subscription)
          </b-button>
...
export default class SubscribeForm extends Vue {
  ...
  private incomeLevelOptions: string[] = ['Minimum Wage with the Biggest Heart', '20000€-50000€', '50000€+']
  private genderOptions: string[] = ["Male", "Female", "Not Specified", "Apache Helicopter"]
